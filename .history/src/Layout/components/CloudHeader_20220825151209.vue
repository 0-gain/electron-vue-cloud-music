    ...
    <div class="search_wrapper">
      ...
      <div class="searchSuggest" v-show="searchWord">
        ...
        <div class="songs">
          ...
          <div class="item" v-for="(s,index) in SearchSuggest.songs" :key="index">
        ...
        <div class="artists">
          ...
          <div class="item" v-for="(a,index) in SearchSuggest.artists" :key="index">
            {{a.name}}
          </div>
        </div>
        ...
        <div class="album">
          ...
          <div class="item" v-for="(a,index) in SearchSuggest.albums" :key="index">
        ...
        <div class="playlist">
          ...
          <div class="item" v-for="(p,index) in SearchSuggest.playlists" :key="index">
            {{p.name}}
          </div>
        </div>
      </div>
