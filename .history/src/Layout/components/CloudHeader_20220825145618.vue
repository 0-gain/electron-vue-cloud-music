<template>
  <div id="header">
    ...
    <div class="search_wrapper">
      ...
      <div class="searchSuggest" v-show="searchWord">
        <div class="title">
          <i class="iconfont icon-search"></i>
          猜你想搜
        </div>
        ...
        <div class="songs">
          ...
          <div class="songs_item" v-for="(s,index) in SearchSuggest.songs" :key="index">
        ...
        <div class="artists">
          ...
          <div class="artist_item" v-for="(a,index) in SearchSuggest.artists" :key="index">
            {{a.name}}
          </div>
        </div>
        ...
        <div class="album">
          ...
          <div class="album_item" v-for="(a,index) in SearchSuggest.albums" :key="index">
        ...
        <div class="playlist">
          ...
          <div class="playlist_item" v-for="(p,index) in SearchSuggest.playlists" :key="index">
            {{p.name}}
          </div>
        </div>
      </div>
