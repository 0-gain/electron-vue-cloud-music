  ...
  <div id="header">
    ...
    <div class="search_wrapper">
      ...
      <div class="search" @click="clickSearch">
        ...
        <el-input v-model="searchWord" :placeholder="defaultKeyword" v-on:keyup.enter.native="search(searchWord)"></el-input>
      </div>
...
export default {
  ...
  watch:{
    // 监听关键词
    searchWord(val){
      // 如果有值，则赋值给defaultKeyword
      if(val){
        console.log(val)
        this.searchWord = this.defaultKeyword
      }
    }
  }
};
