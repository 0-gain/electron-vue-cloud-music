      ...
      <table>
        <thead v-show="(showType !== 'singerIndex') && (showType !== 'rank')">
          <tr>
            ...
            <th>音乐标题</th>
            <th>歌手</th>
            <th v-show="(showType != 'rank') && (showType != 'singerIndex') && (showType != 'recent')">专辑</th>
            <th v-show="(showType != 'rank') && showType != 'recent'">时长</th>
            <th v-show="(showType === 'searchSong') || (showType === 'albumList')">热度</th>
        ...
        <tbody>
          ...
          >
            ...
            <td class="icon" v-show="(showType != 'rank') && (showType != 'recent')">
            ...
            <!-- 显示专辑 -->
            <td class="album" v-show="(showType != 'rank') && (showType != 'singerIndex') && (showType != 'recent')">
            ...
            <!-- 歌曲热度 -->
            <td class="pop" v-show="(showType === 'searchSong') || (showType === 'albumList')">
              <el-progress :percentage="track.pop"></el-progress>
            </td>

            <!-- 播放时间 -->
            <td class="playTime" v-show="showType === 'recent'"></td>
          </tr>
        </tbody>
      </table>
      <div
