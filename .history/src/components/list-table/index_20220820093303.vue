  ...
  <div class="rank-item">
    <div class="rank-cover">
      <div
        v-if="isShowCover"
        class="coverImg"
        @mouseenter="isShowPlay = true && isRanking"
        @mouseleave="isShowPlay = false && isRanking"
        @click="
    ...
    <div class="rank-content">
      ...
      <table>
        <thead v-show="showType != 'rank'">
          <tr>
            <th></th>
            <th v-show="isShowIcon"></th>
            <th>音乐标题</th>
            <th>歌手</th>
            <th>专辑</th>
            <th v-show="isShowTime">时长</th>
            <th v-show="isShowProgress">热度</th>
          </tr>
        </thead>
        <tbody>
          <tr
          ...
          >
            ...
            <td class="icon" v-show="isShowIcon">
            ...
            <!-- 显示专辑 -->
            <td class="album" v-show="showType != 'rank'">
              <span>{{ track.al.name }}</span>
            </td>

            <!-- 显示歌曲时间 -->
            <td class="dt" v-show="isShowTime">
              {{ track.dt | moment("mm:ss") }}
            </td>

            <!-- 歌曲热度 -->
            <td class="pop" v-show="isShowProgress">
