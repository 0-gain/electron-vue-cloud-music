...
export const reqRecommendSongMenu = (limit) =>
...
export const reqNewSong = (limit) =>
  request.get(`/personalized/newsong?limit=${limit}`);

// 推荐MV
export const reqMV = () => request.get("/personalized/mv");

// 每日推荐歌单
export const reqRecommendPlaylist = () => request.get("/recommend/resource");

// 每日推荐歌曲
export const reqRecommendSongs = () =>
  request.get("/recommend/songs", { params: { _: new Date().getTime() } });
